...
Because the Tabbre Project will only sell its energy for BRE, BRE will become a currency whose value is underpinned by production and sale of energy. BRE will be backed by energy.
...
The Tabbre Project’s objective is to become the principal global supplier of energy. As such, once the Tabbre Project has matured it is expected to be hugely profitable.
